...
describe('Unit Test for loadSubsFromPluginConfig Funtion', () => {
  ...
  it('should return early if no subscriptions are found', async () => {
    const mockedGetPluginConfig = getPluginConfig as jest.MockedFunction<typeof getPluginConfig>;
  ...
  it('should successfully load subscriptions', async () => {
    ...
    const mockedGetFromStore = getFromStore as jest.MockedFunction<typeof getFromStore>;
