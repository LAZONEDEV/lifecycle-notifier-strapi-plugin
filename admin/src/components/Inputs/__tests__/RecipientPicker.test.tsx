...
const Component = (props: Partial<Omit<RecipientPickerProps, 'aria-label'>>) => (
...
describe('test suite for AttachableFilePicker component', () => {
  it('should render the select and the options', async () => {
    const option1Label = createRecipientLabel(envRecipients[0], activeCollection);
  ...
  it('should update formik context', async () => {
    ...
    const optionToSelect = createRecipientLabel(recipientToSelect, activeCollection);
    const expectValue = {
