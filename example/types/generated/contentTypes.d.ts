...
export interface ApiPlanetPlanet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    by: Schema.Attribute.Relation<'oneToOne', 'plugin::users-permissions.user'>;
    config: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    discoveryDate: Schema.Attribute.DateTime;
    email: Schema.Attribute.Email;
...
export interface PluginLifecycleNotifierLifecycleSubscription extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    planet: Schema.Attribute.Relation<'oneToOne', 'api::planet.planet'>;
